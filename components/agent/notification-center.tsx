...
const notifications = [
  {
    ...
    message: 'Your property "Luxury Villa in Al Olaya" has been approved and is now visible to the public.',
  ...
  },
  {
    ...
    message: 'Your property "Studio Apartment" has been rejected. Please update the information and resubmit.',
  ...
  },
  {
    ...
    message: "Your real estate license will expire in 30 days. Please renew it before expiration.",
  ...
  },
  {
    ...
    message: "The system will be undergoing maintenance on November 20th from 2:00 AM to 4:00 AM (GMT+3).",
  ...
  },
  {
    ...
    message: "We've added a new map feature to help you visualize your property locations. Check it out!",
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Stay updated with property approvals, system announcements, and more.</p>
        </div>
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-5">
              ...
              <TabsTrigger value="success">Approved</TabsTrigger>
              <TabsTrigger value="error">Rejected</TabsTrigger>
